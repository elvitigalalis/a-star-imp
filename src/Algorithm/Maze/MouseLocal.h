...
public:
     ...
     */
    std::array<int, 2> turnMouseLocal(const std::array<int, 2>& newDirection);
     ...
     * @return An array containing the number of half steps and the direction to turn (left or right).
     */
    std::array<int, 2> obtainHalfStepCount(const std::array<int, 2>& newDirection);
     ...
     */
    int findDirectionIndexInPossibleDirections(const std::array<int, 2>& direction) const;
     ...
     */
    void addWallLocal(int x, int y, const std::array<int, 2>& direction);
     ...
     */
    std::array<int, 2> getDirectionOffset(const std::string& direction) const;
     ...
     */
    std::array<int, 2> getMouseDirection() const;
     ...
     */
    void setMouseDirection(const std::array<int, 2>& newDirection);
     ...
     */
    std::string localMazeToString() const;
     ...
     */
    std::vector<Cell*> getNeighbors(const Cell& cell, bool diagonalsAllowed) const;
     ...
     */
    static std::array<int, 2> getDirBetweenCells(const Cell& cell1, const Cell& cell2);
...
private:
     ...
     */
    std::string printRow(int rowNumber) const;
