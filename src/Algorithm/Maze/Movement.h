...
public:
     ...
     */
    Movement(bool canMove, const std::array<int, 2>& direction);
     ...
     * @param direction The direction of movement as an array [dx, dy].
     */
    Movement(bool canMove, bool isDiagonal, const std::string& leftOrRightDiagonal, Cell* cellToMoveToFirst, const std::array<int, 2>& direction);
     ...
     */
    std::string getIsLeftRight() const;
     ...
     */
    std::array<int, 2> getDirection() const;
     ...
     */
    void setLeftOrRightDiagonal(const std::string& leftOrRightDiagonal);
